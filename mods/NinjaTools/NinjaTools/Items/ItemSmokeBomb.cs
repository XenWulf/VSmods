...
namespace NinjaTools.Items
{
    internal class ItemSmokeBomb : Item
    {
        ...
        public override void OnHeldInteractStop(float secondsUsed, ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel)
        {
            ...
            EntityProperties type = byEntity.World.GetEntityType(new AssetLocation("thrownsnowball-"));
            ...
            entity.ServerPos.SetPos(byEntity.ServerPos.BehindCopy(0.21).XYZ.Add(0, byEntity.LocalEyePos.Y, 0));
...
//                 byEntity.ServerPos.BehindCopy(0.21).XYZ.Add(0, byEntity.LocalEyePos.Y, 0) );
        ...
        public override void GetHeldItemInfo(ItemSlot inSlot, StringBuilder dsc, IWorldAccessor world, bool withDebugInfo)
        {
            ...
            dsc.AppendLine(Lang.Get("Creates a cloud of smoke on impact"));
        }
